...
class PanCardAddingScreen extends StatefulWidget {
  ...
  @override
  _PanCardAddingScreenState createState() => _PanCardAddingScreenState();
}

class _PanCardAddingScreenState extends State<PanCardAddingScreen> {
  @override
  void initState() {
    super.initState();
  ...
  void initializeControllers() {
    ...
    panController.text = widget.panCard ?? '';
    // Fetch the address data from Hive if needed
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomText(
                      ...
                      fontFamily: CustomFonts.inknut,
                      size: 0.05,
                      text: widget.isEditMode ? 'Edit Pancard Details' : 'Give Pancard Details'),
                  const CustomSizedBoxHeight(height: 0.03),
                  const NameField(),
                  const CustomSizedBoxHeight(height: 0.02),
                  const EmailField(),
