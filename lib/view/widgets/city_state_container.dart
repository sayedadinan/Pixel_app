...
class PostAutoContainer extends StatelessWidget {
  final int index;
  const PostAutoContainer({
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Center(
        child: CustomText(
            text: BlocProvider.of<AutoFillBloc>(context)
                    .state
                    .state[index]
                    .isEmpty
                ? 'State'
                : BlocProvider.of<AutoFillBloc>(context).state.state[index],
